		...
		<section class="container">
			...
			<aside class="col-md-4 sidebar sidebar-right">
				...
				<?php if(is_array($p_title)): foreach($p_title as $key=>$v1): ?><div class="col-xs-12">
						...
						<?php if(is_array($s_title)): foreach($s_title as $key=>$v2): if($v2['c_pid'] == $v1['c_id']): ?><p><a href="<?php echo U('Index/classes',array('class_id'=>$v2['c_id']));?>"><?php echo ($v2['c_name']); ?></a></p><?php endif; endforeach; endif; ?>
